...
2. Skor prioritas dihitung jadi jumlah pelapor, kelas jalan/fasilitas/hal terlapor, dan dapat dilihat secara publik. 
...
Pengembangan LaporKota didasarkan pada sejumlah asumsi dan batasan yang perlu diidentifikasikan sedari awal. 
...
Batasan yang dihadapi salah satunya adalah batasan sumber daya. Perihal ini, batasan yang dihadapi para _developer_ adalah perang Men, men. Lu, kita gimana? Lu buat, anjing.kat lunak ini hanya dikembangkan oleh tim yang terdiri dari 5 mahasiswa. 
...
- Referensi UU: https://peraturan.bpk.go.id/Details/229798/uu-no-27-tahun-2022
- Referensi UU: https://peraturan.bpk.go.id/Details/39047/uu-no-14-tahun-2008